...
for epoch in range(EPOCHS):
    ...
    mi2 = bin_calc_information2(labelixs, activity[:, -1, :], 0.005)
    mi3 = bin_calc_information2(labelixs, activity2[:, 0, :], 0.005)
    mi4 = bin_calc_information2(labelixs, activity2[:, -1, :], 0.005)

    mi_array.append(mi)
    mi2_array.append(mi2)
    mi3_array.append(mi3)
    mi4_array.append(mi4)
...
t = np.arange(len(mi_array[:, 0]))
plt.scatter(mi_array[:, 0], mi_array[:, 1], c=t, cmap='inferno', label='Mutual Information Conv1 L1')
plt.scatter(mi2_array[:, 0], mi2_array[:, 1], c=t, cmap='inferno', label='Mutual Information Conv1 L4')
plt.scatter(mi3_array[:, 0], mi3_array[:, 1], c=t, cmap='inferno', label='Mutual Information Conv2 L1')
plt.scatter(mi4_array[:, 0], mi4_array[:, 1], c=t, cmap='inferno', label='Mutual Information Conv2 L4')
plt.xlabel('I(X,T)')
plt.ylabel('I(Y,T)')
plt.grid()
plt.legend()
